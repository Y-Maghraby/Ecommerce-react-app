                            ...
                            <div className="course-item style-4">
                                <div className="course-inner">
                                    ...
                                    <div className="course-content">
                                        <Link to={`/shop/${element.id}`} ><h5>{element.title}</h5></Link>
                                        <div className="course-footer">
                                            <div className="course-author">
                                            <Link to="/" className="ca-name">{element.brand}</Link>
                                           </div>
                                           <div className="course-price">{element.price}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
